...
public class PartOneTestCases
{
   ...
   public void testUtilCircle() {
      double d = Util.perimeter(new Circle(new Point(5.0,0.0),0.0));
      assertEquals(0, d, DELTA);
   }

   @Test
   public void testUtilCircle2() {
      double d = Util.perimeter(new Circle(new Point(4.0,4.0),10.0));
      assertEquals(62.83185307, d, DELTA);
   }

   @Test
   public void testUtilCircle3() {
      double d = Util.perimeter(new Circle(new Point(-5.0,4.0),10.0));
      assertEquals(62.83185307, d, DELTA);
   }

   @Test
   public void testUtilRectangle() {
      double d = Util.perimeter(new Rectangle(new Point(0.0,4.0),new Point(4.0,0.0)));
      assertEquals(16.0, d, DELTA);
   }

   @Test
   public void testUtilRectangle2() {
      double d = Util.perimeter(new Rectangle(new Point(0.0,5.0),new Point(4.0,0.0)));
      assertEquals(18.0, d, DELTA);
   }

   @Test
   public void testUtilRectangle3() {
      double d = Util.perimeter(new Rectangle(new Point(4.0,4.0),new Point(0.0,0.0)));
      assertEquals(16.0, d, DELTA);
   }
